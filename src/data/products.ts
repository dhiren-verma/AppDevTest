export const products = [
  {
    ...
    quantity: '2',
    status: "in Stock",
    description: "This course helps us to understand Automation Testing",
  ...
  },
  {
    ...
    quantity: '0',
    status: "4 LEft",
    description: "This course helps us to understand Devops Practices(DEployment, Management, etc)",
